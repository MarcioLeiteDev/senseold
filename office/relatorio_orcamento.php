...
$read->ExeRead("budget" , "WHERE {$queryD}{$query1}{$query2}" , "{$paramD}{$param1}{$param2}");
$read->getResult();
...
$sheet->setCellValue("E{$i}", 'Parceiro');
$sheet->setCellValue("F{$i}", "{$preco}");
...
$writer->save('relatorio_orcamento.xlsx');
...
<html lang="pt-br">
  ...
  <body>
      <a href='./relatorio_orcamento.xlsx' class="btn btn-success m-5"> <h1>Baixar Arquivo</h1> </a>
